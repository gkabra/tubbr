...
extension ImagePicker: UIImagePickerControllerDelegate {
    ...
    public func imagePickerController(_ picker: UIImagePickerController,
        ...
        if let imageUrl = info[.imageURL] as? URL {
            let component = imageUrl.lastPathComponent.components(separatedBy: ".")

            selectedFileName = component[0]
        }
        self.pickerController(picker, didSelect: image, fileName: selectedFileName)
    }
}
